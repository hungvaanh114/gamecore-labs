...
const vi: Record<string, Partial<Project>> = {
  'neon-drifter': {
    ...
    features:['Điều khiển cảm ứng','Camera bám động','Sự kiện đường đua mô-đun','Thông số xe tái sử dụng'], technicalWork:['Kiến trúc điều khiển xe','Lớp trừu tượng đầu vào','Object pooling','Tối ưu cho thiết bị di động'], outcome:'Một ý tưởng demo dùng để minh họa quy trình làm việc, không phải sản phẩm đã phát hành cho khách hàng.', priceEstimate:'Khoảng 25 – 60 triệu VNĐ'
  },
  'tiny-world': {
